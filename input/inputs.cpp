...
bool Inputs::is_key_down(int key) { return key_states[key]; }

bool Inputs::is_key_down_event(int key) { return key_down_event[key]; }

SDL_Point Inputs::get_mouse_pos() { return {mouse_x, mouse_y}; }

bool Inputs::is_mouse_button_down() { return mouse_button_state; }

bool Inputs::get_mouse_button_down_event() { return mouse_button_down_event; }
