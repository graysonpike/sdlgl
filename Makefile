...
lib:
	...
	g++ $(FLAGS) graphics/sprite.cpp        -o build/sprite.o
	g++ $(FLAGS) input/inputs.cpp           -o build/inputs.o
	g++ $(FLAGS) game/clock.cpp             -o build/clock.o
	g++ $(FLAGS) game/scene.cpp             -o build/scene.o
	g++ $(FLAGS) ui/fps_display.cpp         -o build/fps_display.o

	ar rcs build/libsdlgl.a build/graphics.o build/resources.o build/font_renderer.o build/fps_counter.o build/sprite.o build/inputs.o build/clock.o build/scene.o build/fps_display.o