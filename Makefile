...
lib:
	...
	ar rcs build/libsdlgl.a build/graphics.o build/resources.o build/font_renderer.o build/fps_counter.o build/inputs.o build/clock.o build/scene.o build/fps_display.o