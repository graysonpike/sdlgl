...
int main() {
    ...
    scene.add_entity(
        new SoundButton(&scene, 91, 195, 91, 91, {30, 51, 100, 255}, "select"));
    scene.add_entity(new SoundButton(&scene, 273, 195, 91, 91,
                                     {153, 26, 35, 255}, "cancel"));
    scene.add_entity(
        new SoundButton(&scene, 455, 195, 91, 91, {26, 119, 26, 255}, "send"));
