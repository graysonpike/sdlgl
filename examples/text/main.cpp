...
int main() {
    ...
    TypewriterText typewriter1(50, 150, "This is a typewriter text example without max width. It will type out character by character with a nice effect.", "base_text", 0.05f);
    TypewriterText typewriter2(50, 250, "This is another typewriter example with max width of 200 pixels. It will wrap the text when it reaches the limit.", "base_text", 0.05f, 200);
    ...
    while (loop) {
        ...
        // Instructions
        Text::draw_text_left_justified(50, 400, "Press SPACE to reset typewriter effects", "base_text", {0, 100, 0});
