...
std::pair<float, float> Math::rotate_about_point(
    std::pair<float, float> center, std::pair<float, float> moved_point,
    float angle) {
    ...
    new_point.first =
        (moved_point.first * cos(angle)) - (moved_point.second * sin(angle));
    new_point.second =
        (moved_point.second * cos(angle)) + (moved_point.first * sin(angle));
...
std::pair<float, float> Math::add_vectors(std::pair<float, float> a,
                                          std::pair<float, float> b) {
    return std::pair<float, float>(a.first + b.first, a.second + b.second);
}

std::pair<float, float> Math::scale_vector(std::pair<float, float> v,
                                           float factor) {
